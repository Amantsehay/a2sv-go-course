...
func NewMongoTaskRepository() (*MongoTaskRepository, error) {
	_, tasksCollection := Infrastructure.CollectionNames()
	if tasksCollection == nil {
		return nil, errors.New("failed to retrieve the tasks collection")
	}
	return &MongoTaskRepository{collection: tasksCollection}, nil
}
